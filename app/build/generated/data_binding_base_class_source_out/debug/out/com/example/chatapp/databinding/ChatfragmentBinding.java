...
public final class ChatfragmentBinding implements ViewBinding {
  ...
  private ChatfragmentBinding(@NonNull RelativeLayout rootView,
  ...
  public static ChatfragmentBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.chatfragment, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static ChatfragmentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ChatfragmentBinding((RelativeLayout) rootView, recyclerview);
    }
